...
import { resetResetPasswordFTime} from "../../redux/user/userSlice.js";
import {Formik} from "formik";

const ChangePasswordFt = () => {
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        dispatch(resetResetPasswordFTime(values.code,values.newPassword,values.confirmPassword,navigate))
        resetForm();
    };
...
export default ChangePasswordFt;