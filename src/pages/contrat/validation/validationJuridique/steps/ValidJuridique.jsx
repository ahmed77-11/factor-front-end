...
import {useNavigate, useParams} from "react-router-dom"; // For example, to get an ID from the URL
...
const ValidJuridique = () => {
    ...
    const handleTaskEvent = (decision) => {
        sendTaskAction({"taskId":notification.notificationTaskId,"actionType":"COMPLETE","variables":{"token":current.token,"reviewDecision":decision,"juristeId":"1","notes":description}}); // Mark as read in real-time
